        ...
        <div class="col-md-6 col-xl-4 a2">
            <div class="justify-content-center px-lg-4 py-4 col-12">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">{{ __('Stage') }}</div>
                            <div class="card-body">
                                @include('admin.include.stage_form')
                            </div>
                        </div>
                    </div>
                </div>
...
{{--        <script src="{{asset('js/admin/ajaxUpdateStage.js')}}"></script>--}}
{{--    <script src="{{asset('js/admin/ajaxDeleteStage.js')}}"></script>--}}
@endsection
